...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_show.setStyleSheet("border-image: url(:/icons/ui_imgs/laji.png);")
        ...
        self.label_3.setGeometry(QtCore.QRect(210, 0, 811, 51))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基于计算机视觉的鹿只高温预警系统"))
        ...
        self.label_3.setText(_translate("MainWindow", "基于计算机视觉的鹿只高温预警系统"))
# import ui_sources_rc  # 注释掉，如果不需要资源文件可以删除此行
